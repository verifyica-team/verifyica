...
public class ShuffleTestClassesEngineInterceptor implements EngineInterceptor {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(ShuffleTestClassesEngineInterceptor.class);
    ...
    public InterceptorResult interceptDiscovery(
        ...
        if (Constants.TRUE.equals(
            ...
            if (LOGGER.isTraceEnabled()) {
                LOGGER.trace("shuffling test classes");
            }

            Collections.shuffle(engineDiscoveryInterceptorContext.getTestClasses());
        }
