...
/** Class to implement ImmutableEngineInterceptorContext */
public class ImmutableEngineInterceptorContext implements EngineInterceptorContext {
    ...
    public EngineContext getEngineContext() {
        return engineInterceptorContext.getEngineContext();
    }
}
