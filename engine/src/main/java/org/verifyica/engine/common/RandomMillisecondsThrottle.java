...
public class RandomMillisecondsThrottle implements Throttle {

    private static final Logger LOGGER = LoggerFactory.getLogger(RandomMillisecondsThrottle.class);
     ...
     */
    public RandomMillisecondsThrottle(String name, long minimum, long maximum) {
        this.name = name;
