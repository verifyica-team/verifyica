...
public class KeyedMutexManagerTryLockTest {

    private static final String LOCK_KEY = KeyedMutexManagerTryLockTest.class.getName() + ".lockKey";
    ...
    public void test3(ArgumentContext argumentContext) throws InterruptedException {
        if (KeyedMutexManager.tryLock(LOCK_KEY)) {
            try {
