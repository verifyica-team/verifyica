...
public class ClassInterceptorTest5 {
    ...
    public static ClassInterceptor[] interceptors1() {
        System.out.printf("%s interceptors1()%n", ClassInterceptorTest5.class.getName());

        ClassInterceptor[] classInterceptors = new ClassInterceptor[2];
        classInterceptors[0] = new ExampleClassInterceptor1();
        classInterceptors[1] = new ExampleClassInterceptor1();
    ...
    public static Collection<ClassInterceptor> interceptors2() {
        System.out.printf("%s interceptors2()%n", ClassInterceptorTest5.class.getName());
