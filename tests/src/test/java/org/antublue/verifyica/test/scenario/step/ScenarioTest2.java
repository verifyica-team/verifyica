...
public class ScenarioTest2 {
    ...
    @Verifyica.Test
    @Step(tag = "stepB")
    public void testB(ArgumentContext argumentContext) {
        System.out.printf(
                "testB(name[%s], payload[%s])%n",
                argumentContext.getTestArgument(), argumentContext.getTestArgument().getPayload());
    }

    @Verifyica.Test
    @Step(tag = "stepC", nextTag = "stepB")
    public void testC(ArgumentContext argumentContext) {
        System.out.printf(
                "testC(name[%s], payload[%s])%n",
                argumentContext.getTestArgument(), argumentContext.getTestArgument().getPayload());
    }
