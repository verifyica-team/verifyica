...
/** Class to implement ExampleAutoLoadClassInterceptor1 */
@Verifyica.AutowiredInterceptor
public class ExampleAutoLoadClassInterceptor1 implements ClassInterceptor {

    /** Constructor */
    public ExampleAutoLoadClassInterceptor1() {
