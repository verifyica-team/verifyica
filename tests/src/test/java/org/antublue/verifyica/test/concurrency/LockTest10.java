...
public class LockTest10 {
    ...
    private static final String LOCK_KEY = LockTest10.class.getName() + ".lockKey";
    ...
    public void test2(ArgumentContext argumentContext) throws Throwable {
        ConcurrencySupport.LockReference lockReference = ConcurrencySupport.getLock(LOCK_KEY);

        if (lockReference.tryLock(100, TimeUnit.MILLISECONDS)) {
            try {
                System.out.println(format("test2(%s) locked", argumentContext.getTestArgument()));
                ...
                System.out.println(format("test2(%s) unlocked", argumentContext.getTestArgument()));
            } finally {
    ...
    public static void conclude(ClassContext classContext) {
        System.out.println(format("lock count [%d]", ConcurrencySupport.getLockCount()));
        assertThat(ConcurrencySupport.getLockCount()).isEqualTo(0);
    }
}
